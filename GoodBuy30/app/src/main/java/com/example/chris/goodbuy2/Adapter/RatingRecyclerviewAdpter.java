...
import com.example.chris.goodbuy2.Activity.RatingActivity;
import com.example.chris.goodbuy2.Model.Product_item_detail;
import com.example.chris.goodbuy2.R;

public class RatingRecyclerviewAdpter extends RecyclerView.Adapter<RatingRecyclerviewAdpter.MyViewHolder> implements View.OnClickListener {

    private Product_item_detail product;
    private Context context;
    private LayoutInflater layoutInflater;

    public RatingRecyclerviewAdpter(Context context, Product_item_detail product){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LinearLayout linearLayout = (LinearLayout)layoutInflater.inflate(R.layout.rating_layout, null);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        ...
        AppCompatRatingBar member_rating = linearLayout.findViewById(R.id.member_rating);
